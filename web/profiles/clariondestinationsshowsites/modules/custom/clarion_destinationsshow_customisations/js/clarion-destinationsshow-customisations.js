/**
 * @file: clarion_destinationsshow_customisations.js
 *
...
(function($, Drupal) {
  ...
  //  */
  // Drupal.behaviors.clariondestinationsshowAddSwitcherBarToPage = {
  ...
  //     // $('body').addClass('destinationsshow-switcher-active').prepend('<div id="destinationsshow-switcher"><h3>' + Drupal.t('Venue:') + '</h3><ul><li><a class="' + excel_link_classes + '" href="http://excel.destinationsshows.co.uk">' + Drupal.t('ExCeL London') + '</a></li><li><a class="' + birmingham_link_classes + '" href="http://birmingham.destinationsshows.co.uk">' + Drupal.t('Birmingham') + '</a></li></ul></div>');
  //     // console.log('clarion-destinationsshow-customisations.js added switcher menu to top of page.');
  //   }
  // };
})(jQuery, Drupal);
