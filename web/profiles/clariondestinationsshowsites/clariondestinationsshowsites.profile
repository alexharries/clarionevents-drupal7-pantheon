...
/**
 * @file
 * Enables modules and site configuration for a clariondestinationsshowsites
 * site installation.
 */
 ...
 * @param $install_state
 */
function clariondestinationsshowsites_install_tasks_alter(&$tasks, $install_state) {
  $tasks['install_settings_form']['function'] = 'clariondestinationsshowsites_install_settings_form';
}
 ...
 */
function clariondestinationsshowsites_form_install_configure_form_alter(&$form, $form_state) {
 ...
 * @return mixed
 */
function clariondestinationsshowsites_install_settings_form($form, &$form_state, &$install_state) {
...
//      'profile=clariondestinationsshowsites',
//      'locale=en',
//    );
//
