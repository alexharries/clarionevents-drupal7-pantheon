...
/**
 * @file
 * Enables modules and site configuration for a clarionantiquessites
 * site installation.
 */
 ...
 * @param $install_state
 */
function clarionantiquessites_install_tasks_alter(&$tasks, $install_state) {
  $tasks['install_settings_form']['function'] = 'clarionantiquessites_install_settings_form';
}
 ...
 */
function clarionantiquessites_form_install_configure_form_alter(&$form, $form_state) {
 ...
 * @return mixed
 */
function clarionantiquessites_install_settings_form($form, &$form_state, &$install_state) {
