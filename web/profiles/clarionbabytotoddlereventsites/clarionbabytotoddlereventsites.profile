...
/**
 * @file
 * Enables modules and site configuration for a clarionbabytotoddlereventsites
 * site installation.
 */
 ...
 * @param $install_state
 */
function clarionbabytotoddlereventsites_install_tasks_alter(&$tasks, $install_state) {
  $tasks['install_settings_form']['function'] = 'clarionbabytotoddlereventsites_install_settings_form';
}
 ...
 */
function clarionbabytotoddlereventsites_form_install_configure_form_alter(&$form, $form_state) {
 ...
 * @return mixed
 */
function clarionbabytotoddlereventsites_install_settings_form($form, &$form_state, &$install_state) {
...
//      'profile=clarionbabytotoddlereventsites',
//      'locale=en',
//    );
//
